...
var uiMessages = map[string]map[string]string{
	"en": {
		...
		"auto_land": "Land automatically when finished", "unit_help": "1 unit = 1 cm · minimum linear movement 20 cm",
	...
	"it": {
		...
		"auto_land": "Atterra automaticamente al termine", "unit_help": "1 unità = 1 cm · movimenti lineari minimi 20 cm",
	...
	"fr": {
		...
		"auto_land": "Atterrir automatiquement à la fin", "unit_help": "1 unité = 1 cm · déplacement linéaire minimal 20 cm",
	...
	"de": {
		...
		"auto_land": "Nach Abschluss automatisch landen", "unit_help": "1 Einheit = 1 cm · lineare Mindestbewegung 20 cm",
	...
	"es": {
		...
		"auto_land": "Aterrizar automáticamente al finalizar", "unit_help": "1 unidad = 1 cm · movimiento lineal mínimo 20 cm",
	...
	"pt": {
		...
		"auto_land": "Pousar automaticamente ao terminar", "unit_help": "1 unidade = 1 cm · movimento linear mínimo 20 cm",
	...
	"ar": {
		...
		"auto_land": "الهبوط تلقائياً عند الانتهاء", "unit_help": "وحدة واحدة = 1 سم · الحد الأدنى للحركة الخطية 20 سم",
	...
	"zh": {
		...
		"auto_land": "结束后自动降落", "unit_help": "1 单位 = 1 厘米 · 最小直线移动 20 厘米",
	...
	"ko": {
		...
		"auto_land": "완료 후 자동 착륙", "unit_help": "1 단위 = 1cm · 최소 직선 이동 20cm",
	...
	"ja": {
		...
		"auto_land": "終了時に自動着陸", "unit_help": "1単位 = 1cm · 直線移動の最小値 20cm",
